/// @function scr_simulation_4_step()
...
//scr_output("slope", string_format(slope, 10, 10));
//scr_output("move_h", string_format(move_h, 10, 10));
//scr_output("move_v", string_format(move_v, 10, 10));
