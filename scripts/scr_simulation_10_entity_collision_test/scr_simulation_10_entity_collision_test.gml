/// @function scr_simulation_10_entity_collision_test()
...
// reset the boudning box points list
...
coliision_slope = slope;

new_move_h = move_h;
new_move_v = move_v;

collision_distance_target = point_distance(0, 0, move_h, move_v);
...
if (x_steps > 0)
{
    ...
    collision_y1 = y1;
    collision_axis = axis;
    scr_simulation_10_entity_collision_points();
