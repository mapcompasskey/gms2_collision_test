/// @function scr_simulation_14_step()
...
//var arr = scr_simulation_12_raycast(x1, y1, new_move_h, new_move_v, collision_tilemap, cell_size, 2);
//new_move_h = arr[0];
//new_move_v = arr[1];
//arr = noone;

//scr_simulation_14_raycast(x1, y1, new_move_list, collision_tilemap, cell_size);
//scr_simulation_14_raycast_2(x1, y1, new_move_list, collision_tilemap, cell_size);
scr_simulation_14_raycast_3(x1, y1, new_move_list, bbox_width, bbox_height, collision_tilemap, cell_size);
