/// @function scr_simulation_11_entity_raycast(x1, y1, move_list, tilemap_layer, tile_size, bbox_width, bbox_height, redirected);
    ...
    if ( ! _redirected)
    {
        if (_collision_h || _collision_v)
        {
            if (_move_h != 0 && _move_v != 0)
            {
                ...
                scr_simulation_11_entity_raycast(_start_x2, _start_y2, _move_list, _collision_tilemap, _cell_size, _width, _height, true);
                ...
                {
                    _start_x2 = _start_x + _new_move_h;
                    _start_y2 = _start_y + _new_move_v;
