/// @function scr_simulation_12_raycast(x1, y1, move_h, move_v, tilemap, cell_size, axis)
/// @param {number} x1 the starting x position
/// @param {number} y1 the starting y position
/// @param {number} move_h the distance to move on the x-axis
/// @param {number} move_v the distance to move on the y-axis
...
var move_h = argument2;
var move_v = argument3;
var new_move_h = move_h;
var new_move_v = move_v;

var collision_tilemap = argument4;
var cell_size = argument5;

// 0: horizontal, 1: vertical, 2: both
var step_axis = argument6;
...
while (collision == false && distance_delta < distance_target)
{
    ...
    if (distance_delta <= distance_target)
    {
        ...
        if (check_h_axis) ds_list_add(temp_list, step_x, step_y, global.COLLISION_H_COLOR);
        else if (check_v_axis) ds_list_add(temp_list, step_x, step_y, global.COLLISION_V_COLOR);
        else ds_list_add(temp_list, step_x, step_y, global.COLLISION_HV_COLOR);
