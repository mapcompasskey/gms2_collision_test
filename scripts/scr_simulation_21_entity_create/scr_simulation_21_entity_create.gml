/// @function scr_simulation_21_entity_create()
...
// scripts
script_raycast_collision = scr_simulation_21_entity_raycast;
script_slope_collision = scr_simulation_21_entity_slope;
