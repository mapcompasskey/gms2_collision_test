/// @function scr_simulation_5_draw_gui()
...
if (ds_list_size(gui_ray_2_points) == 4)
{
    x1 = ds_list_find_value(gui_ray_2_points, 0);
    y1 = ds_list_find_value(gui_ray_2_points, 1);
    x2 = ds_list_find_value(gui_ray_2_points, 2);
    y2 = ds_list_find_value(gui_ray_2_points, 3);
