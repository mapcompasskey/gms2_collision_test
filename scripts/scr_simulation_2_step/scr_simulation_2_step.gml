/// @function scr_simulation_2_step()
    ...
    if (distance_target > distance_delta)
    {
        ...
        while (distance_delta < distance_target)
        {
            ...
            if (distance_delta <= distance_target)
            {
                ...
                // if horizontal movement is negative and the x position is directly on a cell
                ...
                // if vertical movement is negative and the y position is directly on a cell
