/// @function scr_simulation_12_tile_def(t, x, y, vx, vy, width, height, tileX, tileY);
...
if (true)
{
    ...
    ds_list_add(_list, lx, ly, global.COLLISION_H_COLOR);
    ...
    var _list = ds_list_create();
    ds_list_add(_list, lx + lvx, ly + lvy, global.COLLISION_V_COLOR);
    ds_list_add(global.GUI_AXIS_POINTS, _list);
    ds_list_mark_as_list(global.GUI_AXIS_POINTS, ds_list_size(global.GUI_AXIS_POINTS) - 1);
}
...
{
    var _list = ds_list_create();
    ds_list_add(_list, (_x + tx), (_y + ty), global.COLLISION_HV_COLOR);
    ds_list_add(global.GUI_AXIS_POINTS, _list);
    ds_list_mark_as_list(global.GUI_AXIS_POINTS, ds_list_size(global.GUI_AXIS_POINTS) - 1);
}


/// @function scr_simulation_12_slope_2(start_x, start_y, cell_x, cell_y, slope, ray_target, tile_at_point);
